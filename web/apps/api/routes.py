...
@api.route('/product/<int:cid>')
@api.route('/product/<int:cid>/<int:page>')
...
@api.route('/search/<string:keywords>')
@api.route('/search/<string:keywords>/<int:page>')
def api_search(keywords='', page=1):
